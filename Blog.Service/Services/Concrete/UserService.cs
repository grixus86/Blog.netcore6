...
namespace Blog.Service.Services.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUnitOfWorks unitOfWorks, IImageHelper imageHelper, IHttpContextAccessor httpContextAccessor, IMapper mapper, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<AppRole> roleManager)
        {
        ...
        public async Task<UserProfileDto> GetUserProfileAsync()
        {
            ...
            var getUserWithImage = await unitOfWorks.GetRepository<AppUser>().GetAsync(x => x.Id == userId, x => x.Image);
        ...
        private async Task<Guid> UploadImageForUser(UserProfileDto userProfileDto)
        {
            ...
            await unitOfWorks.GetRepository<Image>().AddAsync(image);
            return image.Id;
        }
