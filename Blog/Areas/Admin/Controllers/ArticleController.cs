    ...
    public class ArticleController : Controller
    {
        ...
        public async Task<IActionResult> Update(ArticleUpdateDto articleUpdateDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                toast.AddSuccessToastMessage(Messages.Article.Update(title), new ToastrOptions() { Title = "Transaction Successful" });
                return RedirectToAction("Index", "Article", new { Area = "Admin" });
            }
            else
            {
        ...
        public async Task<IActionResult> Delete(Guid articleId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.Article.Delete(title), new ToastrOptions() { Title = "Transaction Successful" });
        ...
        public async Task<IActionResult> UndoDelete(Guid articleId)
        {
            ...
            toast.AddSuccessToastMessage(Messages.Article.UndoDelete(title), new ToastrOptions() { Title = "Transaction Successful" });
